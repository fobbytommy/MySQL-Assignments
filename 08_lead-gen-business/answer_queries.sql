...
# 4. What query would you run to get total # of sites created each month for
#    the client with an id of 1? What about for client=20?
SELECT client_id, COUNT(site_id) AS num_of_websites, 
...
# 5. What query would you run to get the total # of leads we've generated for 
#    each of our sites between January 1, 2011 to February 15, 2011?
